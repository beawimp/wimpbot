...
#
# Commands:
#   hubot cah (q|question) card - Returns a question
#   hubot cah card me - Displays an answer
#   hubot cah card 2 - Displays two answers for questions with two blanks
#
# Author:
